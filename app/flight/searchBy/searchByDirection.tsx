...
import { useDirectionList } from "@/hooks/direction/useDirectionListData";
...
const SearchByDirection = () => {
  ...
  const { date, airportCode, directionCode } = params;
  const { data, loading } = useDirectionList(date, airportCode, directionCode);
    ...
    <View style={{ flex: 1 }}>
      ...
      <View style={[styles.headerCard, { width: CARD_WIDTH }]}>
        ...
        <View style={[styles.ticketContent]}>
          <Text style={styles.airlineName}>MGL</Text>
          <Text style={styles.airlineTitle}>MIAT MONGOLIAN AIRLINES</Text>
        </View>
      </View>
            ...
            <View style={styles.row}>
              ...
              <View
                style={[
                  ...
                  {
                    backgroundColor:
                      item.status_en === "DEPARTED" ? "#4CAF50" : "#1E88E5",
                  },
                ]}
              >
